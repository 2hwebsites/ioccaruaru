<?php	
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=index.php?p=dicas&cat=3&us=".$usuario['id']."'>";
	}

	include "../connections/conn.php";

	$res_dica = mysqli_fetch_assoc(mysqli_query($conn, "SELECT titulo, subtitulo, thumb, nao_exibir_thumb, thumb_banner, video,
	...
	<form onSubmit="return critica(this);" action ="" method="post" enctype="multipart/form-data" name="dica_editar" 
    	...
    	<fieldset>
            ...
            <label id="banner_destaque" style="display:none" class="full lblInputFile">
                <strong class="legendaCampos">Imagem Banner<span class="alertaLegenda">*Apenas arquivos .jpg</span></strong>
