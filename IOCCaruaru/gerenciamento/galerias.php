<?php
	...
	if(@$_GET['acao'] == '3'){
		...
		mysqli_close($conn);
		redireciona("index.php?p=galerias&cat=1&us=".$usuario['id']);
	}
	...
	$paginacao = mysqli_fetch_assoc(mysqli_query($conn, "SELECT count(*) as total FROM ioc_posts WHERE ativo = '1' AND categoria_id = '".$cat."'"));
	...
	if (@mysqli_num_rows($noticiasQy) == '0'){
		echo "<br>Nenhuma galeria encontrada!";
	}else{
?>
...
?>
  <tr bgcolor="<?php echo $cor; ?>" class="lista-conteudo">
    ...
    <td width="300" align="left" valign="middle">
    	<a href="<?php echo "index.php?p=galeria_editar&id=".$id."&us=".$usuario['id']; ?>"><?php echo $titulo; ?></a>
	</td>
...
<div style="clear:both; padding-top:30px;">
	<center><?php echo paginacao($page, $total, "index.php?p=galerias&cat=1&us=".$usuario['id']."&pg="); ?></center>
</div>